...
<script type="module">
	// Setup
	import { WasmGPU } from "https://cdn.jsdelivr.net/gh/Zushah/WasmGPU@0.2.0/dist/WasmGPU.min.js"; // WasmGPU is not on NPM yet so for now you cannot use "@zushah/wasmgpu"
...
```html
<script src="https://cdn.jsdelivr.net/gh/Zushah/WasmGPU@0.2.0/dist/WasmGPU.iife.min.js"></script>
```
