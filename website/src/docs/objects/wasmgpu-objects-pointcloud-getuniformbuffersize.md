# PointCloud.getUniformBufferSize

## Summary
PointCloud.getUniformBufferSize returns the current uniform buffer size value derived from this PointCloud runtime state.
