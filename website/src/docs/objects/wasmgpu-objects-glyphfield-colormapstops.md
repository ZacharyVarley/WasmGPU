...
## Summary
GlyphField.colormapStops reads the current `colormapStops` value from this GlyphField instance. Use it to inspect runtime state without mutating resources.
