# GlyphField.markUniformsDirty

## Summary
GlyphField.markUniformsDirty updates internal dirty/clean tracking flags that control upload or uniform refresh behavior.

## Syntax
```ts
GlyphField.markUniformsDirty(): void
glyphField.markUniformsDirty();
```
