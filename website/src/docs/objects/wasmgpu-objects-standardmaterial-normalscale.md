...
## Summary
StandardMaterial.normalScale reads the current `normalScale` value from this StandardMaterial instance. Use it to inspect runtime state without mutating resources.
