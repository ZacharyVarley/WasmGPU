...
## Summary
StandardMaterial.emissiveTexture reads the current `emissiveTexture` value from this StandardMaterial instance. Use it to inspect runtime state without mutating resources.
