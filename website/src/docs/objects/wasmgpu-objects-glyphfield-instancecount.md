# GlyphField.instanceCount

## Summary
GlyphField.instanceCount reads the current `instanceCount` value from this GlyphField instance. Use it to inspect runtime state without mutating resources.
