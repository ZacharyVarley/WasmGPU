# DataMaterial.shading

## Summary
DataMaterial.shading reads the current `shading` value from this DataMaterial instance. Use it to inspect runtime state without mutating resources.
