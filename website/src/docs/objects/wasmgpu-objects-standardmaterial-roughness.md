...
## Summary
StandardMaterial.roughness reads the current `roughness` value from this StandardMaterial instance. Use it to inspect runtime state without mutating resources.
