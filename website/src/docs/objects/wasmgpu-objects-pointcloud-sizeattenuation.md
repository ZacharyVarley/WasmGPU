# PointCloud.sizeAttenuation

## Summary
PointCloud.sizeAttenuation reads the current `sizeAttenuation` value from this PointCloud instance. Use it to inspect runtime state without mutating resources.
