# StandardMaterial.occlusionStrength

## Summary
StandardMaterial.occlusionStrength reads the current `occlusionStrength` value from this StandardMaterial instance. Use it to inspect runtime state without mutating resources.
