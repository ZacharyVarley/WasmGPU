...
## Summary
StandardMaterial.getUniformBufferSize returns the current uniform buffer size value derived from this StandardMaterial runtime state.

## Syntax
```ts
StandardMaterial.getUniformBufferSize(): number
