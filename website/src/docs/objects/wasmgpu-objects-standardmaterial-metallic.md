...
## Summary
StandardMaterial.metallic reads the current `metallic` value from this StandardMaterial instance. Use it to inspect runtime state without mutating resources.
