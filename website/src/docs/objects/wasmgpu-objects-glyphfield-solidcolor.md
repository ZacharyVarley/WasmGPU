# GlyphField.solidColor

## Summary
GlyphField.solidColor reads the current `solidColor` value from this GlyphField instance. Use it to inspect runtime state without mutating resources.
...
## Returns
`Color4` - Current accessor value exposed by the runtime object.
