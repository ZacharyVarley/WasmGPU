...
## Summary
GlyphField.dirtyUniforms reads the current `dirtyUniforms` value from this GlyphField instance. Use it to inspect runtime state without mutating resources.
