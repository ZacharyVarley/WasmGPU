...
## Summary
StandardMaterial.alphaCutoff reads the current `alphaCutoff` value from this StandardMaterial instance. Use it to inspect runtime state without mutating resources.
