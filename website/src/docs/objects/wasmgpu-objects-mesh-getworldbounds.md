...
## Summary
Mesh.getWorldBounds returns the current world bounds value derived from this Mesh runtime state.

## Syntax
```ts
Mesh.getWorldBounds(): Bounds3
const result = mesh.getWorldBounds();
```
