...
## Summary
Scene.clearPointClouds removes only point cloud objects from the scene. Meshes, glyph fields, and lights remain unchanged. Use it when streaming or reloading point cloud data independently.
