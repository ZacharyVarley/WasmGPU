...
export type { Color, Color4, TextureCoordinateSet, TextureTransform, TextureTransformDescriptor, MaterialDescriptor, UnlitMaterialDescriptor, StandardMaterialDescriptor, StandardMaterialExtensionsDescriptor, StandardMaterialExtensions, StandardMaterialClearcoatExtensionDescriptor, StandardMaterialTransmissionExtensionDescriptor, StandardMaterialVolumeExtensionDescriptor, StandardMaterialSpecularExtensionDescriptor, StandardMaterialSheenExtensionDescriptor, StandardMaterialIridescenceExtensionDescriptor, StandardMaterialAnisotropyExtensionDescriptor, StandardMaterialIorExtensionDescriptor, StandardMaterialEmissiveStrengthExtensionDescriptor, DataMaterialDescriptor, DataMaterialVisualChangeKind, CustomMaterialDescriptor, UniformType, UniformDefinition } from "./graphics/material";
