...
#[no_mangle]
pub extern "C" fn transform_update_partial_ordered(out_world: u32, out_local: u32, pos: u32, rot: u32, scl: u32, parent_u32: u32, order_u32: u32, dirty_indices_u32: u32, dirty_count: u32, count: u32) -> u32 {
    unsafe {
        let n = count as usize;
        ...
        for k in 0..n {
            ...
            let parent_affected = pidx != u32::MAX && (pidx as usize) < n && affected[pidx as usize];
