use crate::shared::{u32_slice, i32_slice, i32_slice_mut};
...
#[no_mangle]
pub extern "C" fn ndarray_strides_row_major(out_strides_ptr: u32, shape_ptr: u32, ndim: u32, elem_bytes: u32) -> u32 {
    let n = ndim as usize;
    let shape = unsafe { u32_slice(shape_ptr, n) };
...
#[no_mangle]
pub extern "C" fn ndarray_offset_bytes(shape_ptr: u32, strides_ptr: u32, indices_ptr: u32, ndim: u32, base_offset_bytes: u32) -> u32 {
    let n = ndim as usize;
    if n == 0 {
