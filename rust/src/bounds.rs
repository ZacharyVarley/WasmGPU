...
#[inline(always)]
unsafe fn write_zero_bounds(out_box_min_ptr: u32, out_box_max_ptr: u32, out_sphere_center_ptr: u32, out_sphere_radius_ptr: u32) {
...
#[inline(always)]
unsafe fn compute_bounds_positions_stride(out_box_min_ptr: u32, out_box_max_ptr: u32, out_sphere_center_ptr: u32, out_sphere_radius_ptr: u32, points_ptr: u32, count: usize, stride_f32: usize) {
    if count == 0 {
        write_zero_bounds(
            out_box_min_ptr,
            out_box_max_ptr,
...
#[inline(always)]
fn rotate_vector_by_quat(vx: f32, vy: f32, vz: f32, qx: f32, qy: f32, qz: f32, qw: f32) -> (f32, f32, f32) {
...
#[no_mangle]
pub extern "C" fn bounds_pointcloud_xyzs(out_box_min_ptr: u32, out_box_max_ptr: u32, out_sphere_center_ptr: u32, out_sphere_radius_ptr: u32, points_ptr: u32, point_count: u32, stride_f32: u32) -> u32 {
    unsafe {
...
#[no_mangle]
pub extern "C" fn bounds_geometry_positions(out_box_min_ptr: u32, out_box_max_ptr: u32, out_sphere_center_ptr: u32, out_sphere_radius_ptr: u32, positions_ptr: u32, vertex_count: u32) -> u32 {
    unsafe {
        if out_box_min_ptr == 0
            || out_box_max_ptr == 0
            || out_sphere_center_ptr == 0
...
#[no_mangle]
pub extern "C" fn bounds_glyph_instances(out_box_min_ptr: u32, out_box_max_ptr: u32, out_sphere_center_ptr: u32, out_sphere_radius_ptr: u32, positions_ptr: u32, scales_ptr: u32, rotations_ptr: u32, instance_count: u32, glyph_center_ptr: u32, glyph_radius: f32) -> u32 {
    unsafe {
        if out_box_min_ptr == 0
            || out_box_max_ptr == 0
            || out_sphere_center_ptr == 0
