/*
./scripts/build-math-wasm.js builds the Rust WASM math backend and generates:
    - ./build/math.wasm (WebAssembly binary)
    - ./build/math.wat  (WebAssembly text format via WABT wasm2wat; auto-downloaded into ./tools/wabt/)
    - ./build/math.js   (ESM loader + JS compatibility API matching the original AssemblyScript exports)
    - ./build/math.d.ts (TypeScript declarations)
...
const wasmOut = join(BUILD_DIR, "math.wasm");
copyFileSync(wasmIn, wasmOut);

const watOut = join(BUILD_DIR, "math.wat");
...
if (madeWat) console.log(`Generated WAT           -> .\\build\\math.wat`);
else console.log(`Note: .\\build\\math.wat not generated (auto-download failed and no system wasm2wat/wasm-tools found).`);

const wasmBytes = readFileSync(wasmOut);
const wasmBase64 = wasmBytes.toString("base64");

const generateMathLoaderJS = (wasmB64) => `// Auto-generated by ./scripts/build-math-wasm.js.
...
const generateMathDTS = () => `// Auto-generated by ./scripts/build-math-wasm.js.
...
writeFileSync(join(BUILD_DIR, "math.js"), generateMathLoaderJS(wasmBase64), "utf8");
writeFileSync(join(BUILD_DIR, "math.d.ts"), generateMathDTS(), "utf8");

console.log(`\nBuilt Rust WASM math -> .\\build\\math.wasm`);
console.log(`Generated loader        -> .\\build\\math.js`);
console.log(`Generated types         -> .\\build\\math.d.ts\n`);
